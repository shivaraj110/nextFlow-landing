...
const faqs = [
	{
		question: "How does NexFlow's automation work?",
		answer:
			'NexFlow uses a visual workflow builder where you can connect different apps and actions using drag-and-drop. When triggered, workflows execute automatically, moving data between apps and performing actions based on your rules.',
	},
	{
	...
	{
		question: 'Do I need technical knowledge to use NexFlow?',
		answer:
	...
	{
		question: 'Can I try NexFlow before purchasing?',
		answer:
	...
	{
		question: 'Is my data secure with NexFlow?',
		answer:
